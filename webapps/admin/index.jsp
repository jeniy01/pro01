...
<head>
    ...
    .page_tit { text-align:center; font-size:41px; padding-top:80px; padding-bottom:30px; }
    .tb_wrap { clear:both; width:900px; margin:10px auto; border-top:2px solid #333; padding-top:15px; }
   	.detail { display:block; text-align:center; max-width:120px; min-width:90px; padding:12px; font-size:21px; background-color: rgba(80, 14, 14, 0.9); color:#fff; border-radius:30px; margin:42px auto; }
        ...
        <div class="content">
            ...
            <section class="page" id="page1">
                ...
                <article class="grid3" style="margin:10px auto;">
	                ...
	                <a href="member_manage.jsp" class="detail">더보기</a>
	            </article>
			</section>
            <section class="page" id="page2">
                ...
                <article class="grid3" style="margin:10px auto;">
	                ...
	                <a href="board_manage.jsp" class="detail">더보기</a>
	            </article>
			</section>
